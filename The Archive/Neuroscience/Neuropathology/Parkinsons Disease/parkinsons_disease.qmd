...
In an SR by Ruiz-Pozo  Systematic Review
Insulin resistance was associated with alpha syn aggregation, dopaminergic neuronal loss, autophagy and neuroinflammation
Blood tests determining insulin sensitivity/metabolic health can be useful in determining risk of developing PD
Once one has PD: 
Enhancing insulin signaling pathways can have neuroprotective effects/improve motor and cognitive fxns in PD patients (Sharma, 2021) (Wang, 2020)
Enhance insulin signaling via: Balanced diet, exercise, antidiabetic agents, insulin therapies
