...
Patient is positioned in the supine.
Ensure the patient's face is shielded (in case of an organic etiology).
Lift the patient's plegic arm, suspending it over the patient's face, then suddenly dropping the arm.
If the patient has FMD, the patient will deflect the arm from hitting the face in the case of FMD.
