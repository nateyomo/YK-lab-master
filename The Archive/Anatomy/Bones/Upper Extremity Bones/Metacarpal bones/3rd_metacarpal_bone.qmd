...
```{python tbl-3rd-mcp-insertion-oian}
#| label: tbl-3rd-mcp-insertion-oian
#| warning: false
#| message: false
#| echo: false
...
if script_file_path.exists():
    ...
    filter_identifiers = ['3rd_metacarpal_bone']  # Replace with actual identifiers you want to include
...
```{python tbl-3rd-mcp-origin-oian}
#| label: tbl-3rd-mcp-origin-oian
#| warning: false
#| message: false
#| echo: false
#| tbl-cap: "Muscles originating from the 3rd Metacarpal bone"
