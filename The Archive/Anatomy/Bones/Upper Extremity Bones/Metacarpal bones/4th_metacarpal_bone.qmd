...
```{python tbl-4th-mcp-insertion-oian}
#| label: tbl-4th-mcp-insertion-oian
#| warning: false
#| message: false
#| echo: false
#| tbl-cap: "Muscles inserting on the 3rd Metacarpal bone"
...
if script_file_path.exists():
    ...
    filter_identifiers = ['4th_metacarpal_bone']  # Replace with actual identifiers you want to include
...
```{python tbl-4th-mcp-origin-oian}
#| label: tbl-4th-mcp-origin-oian
#| warning: false
#| message: false
#| echo: false
#| tbl-cap: "Muscles originating from the 4th Metacarpal bone"
