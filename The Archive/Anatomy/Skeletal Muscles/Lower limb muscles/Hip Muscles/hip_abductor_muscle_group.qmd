...
- [Gluteus Medius]({{< var ref-gluteus-medius.path >}}) @neumannKinesiologyMusculoskeletalSystem2017
- [Gluteus Minimus]({{< var ref-gluteus-minimus.path >}}) @neumannKinesiologyMusculoskeletalSystem2017
...
- [Gluteus Maximus]({{< var ref-gluteus-maximus.path >}}) (anterior/superior fibers) @neumannKinesiologyMusculoskeletalSystem2017
- [Piriformis]({{< var ref-piriformis.path >}}) @neumannKinesiologyMusculoskeletalSystem2017
- [Sartorius]({{< var ref-sartorius.path >}})
- [Rectus Femoris]({{< var ref-rectus-femoris.path >}}) @neumannKinesiologyMusculoskeletalSystem2017
...
- [gluteus medius]({{< var ref-gluteus-medius.path >}}) @neumannKinesiologyMusculoskeletalSystem2017
- [Gluteus minimus]({{< var ref-gluteus-minimus.path >}}) @neumannKinesiologyMusculoskeletalSystem2017
- [TFL]({{< var ref-tensor-fascia-latae.path >}}) @neumannKinesiologyMusculoskeletalSystem2017

```{python tbl-primary-hip-abductor-oian}
#| label: tbl-primary-hip-abductor-oian
#| warning: false
#| message: false
#| echo: false
...
if script_file_path.exists():
    ...
    filter_identifiers = ['primary_hip_abductor']  # Replace with actual identifiers you want to include
...
```{python tbl-secondary-hip-abductor-oian}
#| label: tbl-secondary-hip-abductor-oian
#| warning: false
#| message: false
#| echo: false
...
if script_file_path.exists():
    ...
    filter_identifiers = ['secondary_hip_abductor']  # Replace with actual identifiers you want to include
