...
- Proximal 1/4 of the femoral shaft
    - The [adductor magnus]({{< var ref-adductor-magnus.path >}}) will be the most posteriorly superficial adductor muscle.
    ...
    - Lastly, the [pectineus]({{< var ref-pectineus.path >}}) inserts most anteriorly and thus will be palpated last.
- Middle half of the femoral shaft
    - You will first palpate the [adductor magnus]({{< var ref-adductor-magnus.path >}})
