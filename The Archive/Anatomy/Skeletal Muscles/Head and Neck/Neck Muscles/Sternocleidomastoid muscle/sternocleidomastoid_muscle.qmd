...
Need to be able to tell it:
1. Exceptions (the muscle we are making a synergist with)
1. Synergists & Antagonists
1. For spine rotation and sidebend, we need to be able to instruct if we are talking about ipsilateral or contralateral (maybe make a way to to say contralatera=true to say to run it through that part of the program)
1. Need to be able to give it multiple entries for antagonist, synergist since there are multiple functions
