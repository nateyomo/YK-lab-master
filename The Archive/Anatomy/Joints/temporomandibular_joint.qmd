...
- The disc separates the joint into two synovial joint cavities @neumannKinesiologyMusculoskeletalSystem2017.
    - The inferior joint cavity is between the inferior aspect of the disc and the [mandibular condyle]({{< var ref-mandible-bone.mandibular-condyle >}}) @neumannKinesiologyMusculoskeletalSystem2017.
...
- **Convex**: Mandible head 
- **Concave**: Mandibular fossa of temporal bone

When the mandible moves *on* the mandibular fossa:

- **Depression (Opening mouth)**: Posterior roll + Anterior slide
    - Perform a *anterior* glide to assist with this motion
- **Elevation (Closing mouth)**: Anterior roll + Posterior slide
    - Perform an *posterior* glide to assist with this motion
- **Protrusion**: Mandibular condyle and disc translate *anteriorly*
- **Retrusion**: Mandibular condyle and disc translate *posteriorly*
- **Lateral excursion**: In Left lateral excusrion the L condyle forms a pivot point that the R condyle rotates anteriorly & medially


## Osteokinematics Overview: 
The primary osteokinematics of the mandible are most often described as protrusion and retrusion, lateral excursion, and depression and elevation @neumannKinesiologyMusculoskeletalSystem2017.

:::{.callout-note title="Combined mandibular translationa and rotation"}
With all primary movements, there are varying degrees of combined mandibular translation and rotation @neumannKinesiologyMusculoskeletalSystem2017.
These combined kinematics optimize the mechanical process of mastication.
:::

textbook by Okeson.

![TMJ Depression and elevation (fig 11.15 @neumannKinesiologyMusculoskeletalSystem2017)](/The Archive/Anatomy/Joints/images/TMJ depression and elevation fig11.15 neumannKinesiologyMusculoskeletalSystem2017.png)
![TMJ Lateral excursion (Figure 11.14 @neumannKinesiologyMusculoskeletalSystem2017)](/The Archive/Anatomy/Joints/images/TMJ lateral excursion fig11.14 neumannKinesiologyMusculoskeletalSystem2017.png)
![TMJ Protrusion & Retrusion (Figure 11.13 @neumannKinesiologyMusculoskeletalSystem2017)](/The Archive/Anatomy/Joints/images/TMJ protrusion retrusion fig11.13 neumannKinesiologyMusculoskeletalSystem2017.png)
...
- Lateral excursion refers to the side-to-side translation (primarily) of the mandible on the temporal bone @neumannKinesiologyMusculoskeletalSystem2017
- The direction of this side-to-side movement is described as contralateral or ipsilateral relative to the side of primary muscle action (right or left) @neumannKinesiologyMusculoskeletalSystem2017
- ROM: average adult has 11mm
- In the adult, an average of 11 mm (~$\frac{1}{2}$ inch) @neumannKinesiologyMusculoskeletalSystem2017

Combined movements:

- Lateral excursion is combined with relatively slight rotational movements guided by several factors: @neumannKinesiologyMusculoskeletalSystem2017
    - Occulsion (Contact made between upper and lower teeth)
    - Action of the muscles
    - Shape of the [mandibular fossa]({{< var ref-mandible-bone.mandibular-fossa >}}) and [mandibular condyle]({{< var ref-mandible-bone.mandibular-condyle >}}), and position of the articular disc. For purposes of evaluating dental occlusion, dentists frequently refer to the side of the lateral excursion movement as the “working” side of the mandible." @neumannKinesiologyMusculoskeletalSystem2017
...
With a capsular restriction, the TMJ would have difficulty with **depression** (mouth opening).
...
- Temporomandibular Joint Disorders  and Cranial Counterstrain @myersClinicalCounterstrain2012
