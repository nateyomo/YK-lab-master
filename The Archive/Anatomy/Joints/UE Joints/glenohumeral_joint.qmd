...
- Glenoid fossa tilted upwardly at 5 degrees
- Humerus 
    - → angle of inclination: 135&deg; (frontal plane)
    - → angle of retroversion 30&deg; (tranverse plane)

- GHJ alignment/normal ROM
    - ⅓ of humeral head protruding in front of acromion
...
- Superior GHJ Lig: Taught add, inf, AP translation
- Middle: taught in ER and ant translation
- Inferior: 90 deg of abd, ant fibers: ER, post fibers: IR
- Coracohumeral: ER and ADD
...
- Supraspinatus
- Inclined plane of scapula



## Flexion

Normal: 120&deg; of **pure** GHJ flexion
...
- When adducted, the shoulder should display: 75-85 IR and 60-70 ER
- When Abducted to 90&deg; one should expect more ER=90 deg


# Anterior posterior glide {#ap-glide}

It is important to assess how well the humerus glides anterior to posteriorly on the glenoid.
Anteriorly, we want to assess if the humerus is "adhered" to the anterior joint capsule and tendons.
Posteriorly, we are try to assess whether the posterior rotator cuff ([infraspinatus]({{< var ref-infraspinatus.path >}}) and/or [teres minor]({{< var ref-teres-minor.path >}})) are guarding and shoving the humeral head anteriorly.



# Superior Inferior glide {#sup-inf-glide}

- Supine
- Grip the patient's upper arm and pin their forearm between your elbow and side
- Place your fingertips on the proximal (glenoid) side of the GHJ.
- Pin the capsule and tendinous structures
- Apply pressure into the superior joint line in order to put your fingers between the humerus and glenoid while also driving the humerus inferiorly.
- As you perform the inferior glide, bring the arm into abduction at the same time.
...
# Tissues That Reinforce or Deepen Joint

- Joint capsule and associated GH capsular ligaments @neumannKinesiologyMusculoskeletalSystem2017
- Coracohumeral ligament @neumannKinesiologyMusculoskeletalSystem2017
- Rotator cuff muscles (subscapularis, supraspinatus, infraspinatus, and teres minor) @neumannKinesiologyMusculoskeletalSystem2017
- Long head of the biceps brachii @neumannKinesiologyMusculoskeletalSystem2017
- Glenoid labrum @neumannKinesiologyMusculoskeletalSystem2017
...
The capsular pattern of restriction for the GHJ is ER&gt;abduction&gt;IR In a 3:2:1 ratio [@duttonDuttonOrthopaedicExamination2020].
...
Most/first to least/last limited
...
::: {.callout-note}
Arthrokinematically, *ER* should have the same kinematics as *horizontal abduction* and *extension* so i am not sure why it would be the most limited compared to the other two.
:::
