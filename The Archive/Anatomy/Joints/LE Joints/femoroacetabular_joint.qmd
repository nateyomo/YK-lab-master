...
- [Craig's Test]({{< var ref-craig-hip-test.path >}})
...
When getting a total hip replacement, the rod that is inserted through the femur can worsen fractures.
The difference in materials between the rod and bone can result in the bone shattering or splintering completely if a fracture were to occur.
Without a total hip surgery, that same person could potentially have a less severe fracture.