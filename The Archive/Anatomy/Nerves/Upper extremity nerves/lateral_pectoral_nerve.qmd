...
- [Pec Major]({{< var ref-pectoralis-major.path >}})

```{python tbl-lateral-pectoral-nerve-oian}
#| label: tbl-lateral-pectoral-nerve-oian
#| warning: false
#| message: false
#| echo: false
#| tbl-cap: "Lateral pectoral nerve Muscle Innervations"
