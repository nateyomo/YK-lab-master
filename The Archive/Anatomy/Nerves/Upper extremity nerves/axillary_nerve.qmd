...
```{python tbl-axillary-nerve-oian}
#| label: tbl-axillary-nerve-oian
#| warning: false
#| message: false
#| echo: false
#| tbl-cap: "Axillary Nerve Muscle Innervations"
...
if script_file_path.exists():
    ...
    filter_identifiers = ['axillary_nerve']  # Replace with actual identifiers you want to include
