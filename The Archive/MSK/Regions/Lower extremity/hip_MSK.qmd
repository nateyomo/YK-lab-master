...
There are 3 key bursa of the hip:
<ul>
...
Historically, these structures are often indicated as potential sources of nociception. While trochanteric bursitis may be common, current literature suggests the condition may be one of numerous diagnoses related to lateral hip pain.11 The term greater trochanteric pain syndrome (GTPS) represents a more inclusive consideration of the bursa and gluteal tendon attachments at the trochanteric region. Trochanteric bursitis and gluteal tendinopathy will be examined in the GTPS section of this monograph.11
...
<!-- The abduction-hyperextension-external rotation (AB-HEER) test was found to be most accurate with a sensitivity of 81% and specificity of 89%. While demonstrating a low sensitivity (34%), the prone instability test showed high specificity (98%). The hyperextension-external rotation (HEER) test demonstrated a sensitivity of 71% and a specificity of 85%. The authors reported a cluster of 3 positive tests was associated with a 95% chance of microinstability.5 @aptaCurrentConceptsOrthopaedic2024 -->
